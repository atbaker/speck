# From https://github.com/abetlen/llama-cpp-python/pull/709
#
...
if os.name == 'nt':  # Windows
    ...
    ggml_metal_path = os.path.join(package_path, 'llama_cpp', 'ggml-metal.metal')
    datas.append((ggml_metal_path, 'llama_cpp'))
